...
function notifySwitchingBat0() {
    notify(_('Laptop is running on to Battery1'), 'update');
}

function notifySwitchingBat1() {
    notify(_('Laptop is running on to Battery2'), 'update');
}
